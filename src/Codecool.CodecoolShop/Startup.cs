...
namespace Codecool.CodecoolShop
{
    public class Startup
    {
        ...
        private void SetupInMemoryDatabases()
        {
            ...
            ProductCategory toy = new ProductCategory {Name = "Toy", Department = "Games", Description = "A little game for everyone." };
            ...
            productDataStore.Add(new Product { Name = "Vibrátor szopó automata", DefaultPrice = 33.0m, Currency = "USD", Description = "The best machine.", ProductCategory = toy, Supplier = amazon });
            productDataStore.Add(new Product { Name = "Vibrátor szopó automata", DefaultPrice = 33.0m, Currency = "USD", Description = "The best machine.", ProductCategory = toy, Supplier = amazon });
            productDataStore.Add(new Product { Name = "Vibrátor szopó automata", DefaultPrice = 33.0m, Currency = "USD", Description = "The best machine.", ProductCategory = toy, Supplier = amazon });
            productDataStore.Add(new Product { Name = "Vibrátor szopó automata", DefaultPrice = 33.0m, Currency = "USD", Description = "The best machine.", ProductCategory = toy, Supplier = amazon });
            productDataStore.Add(new Product { Name = "Vibrátor szopó automata", DefaultPrice = 33.0m, Currency = "USD", Description = "The best machine.", ProductCategory = toy, Supplier = amazon });
